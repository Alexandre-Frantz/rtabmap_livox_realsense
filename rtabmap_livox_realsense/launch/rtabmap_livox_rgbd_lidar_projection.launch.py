#!/usr/bin/env python3
"""
rtabmap_livox_rgbd_lidar_projection.launch.py

SLAM mapping using RTAB-MAP on a Leo Rover equiped with a Livox MID 360 LiDAR and a RealSense D455 RGB-D Camera

Usage:

    ros2 launch rtabmap_livox_realsense rtabmap_livox_rgbd_lidar_projection.launch.py
